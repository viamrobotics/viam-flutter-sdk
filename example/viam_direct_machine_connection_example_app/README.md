# Viam Direct Machine Connection Example Flutter App

This example app uses Viam's Flutter SDK to connect to and control a specific machine.

For a more fully-featured example with copious documentation, view the `viam_organization_connection_example_app` in the parent directory.

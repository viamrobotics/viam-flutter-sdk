  ...
  group('Arm RPC Tests', () {
    ...
    group('Arm Service Tests', () {
      ...
      test('jointPositions', () async {
        ...
        expect(response.positions, arm.armJoinPositions);
      });

...
class EntityRef extends $pb.GeneratedMessage {
  ...
  EntityRef._() : super();
  factory EntityRef.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EntityRef.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityRef', package: const $pb.PackageName(_omitMessageNames ? '' : 'opentelemetry.proto.common.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EntityRef copyWith(void Function(EntityRef) updates) => super.copyWith((message) => updates(message as EntityRef)) as EntityRef;
  ...
  @$core.pragma('dart2js:noInline')
  static EntityRef getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EntityRef>(create);
  ...
  @$pb.TagNumber(1)
  set schemaUrl($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)

...
class Resource extends $pb.GeneratedMessage {
  factory Resource({
    ...
    $core.Iterable<$53.EntityRef>? entityRefs,
  }) {
    final $result = create();
    if (attributes != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Resource', package: const $pb.PackageName(_omitMessageNames ? '' : 'opentelemetry.proto.resource.v1'), createEmptyInstance: create)
    ..pc<$53.KeyValue>(1, _omitFieldNames ? '' : 'attributes', $pb.PbFieldType.PM, subBuilder: $53.KeyValue.create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'droppedAttributesCount', $pb.PbFieldType.OU3)
    ..pc<$53.EntityRef>(3, _omitFieldNames ? '' : 'entityRefs', $pb.PbFieldType.PM, subBuilder: $53.EntityRef.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$53.KeyValue> get attributes => $_getList(0);
  ...
  ///  Status: [Development]
  @$pb.TagNumber(3)
  $core.List<$53.EntityRef> get entityRefs => $_getList(2);
}

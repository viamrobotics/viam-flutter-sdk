...
class MLModelServiceClient extends $grpc.Client {
  ...
  static final _$metadata =
      $grpc.ClientMethod<$0.MetadataRequest, $0.MetadataResponse>(
          '/viam.service.mlmodel.v1.MLModelService/Metadata',
          ($0.MetadataRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.MetadataResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.MetadataResponse> metadata($0.MetadataRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class MLModelServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.MetadataResponse> metadata_Pre(
      $grpc.ServiceCall call, $async.Future<$0.MetadataRequest> request) async {
    return metadata(call, await request);
  }

  $async.Future<$0.InferResponse> infer(
      $grpc.ServiceCall call, $0.InferRequest request);
  $async.Future<$0.MetadataResponse> metadata(
      $grpc.ServiceCall call, $0.MetadataRequest request);
}

...
class SensorsServiceClient extends $grpc.Client {
  static final _$getSensors = $grpc.ClientMethod<$0.GetSensorsRequest, $0.GetSensorsResponse>(
      '/viam.service.sensors.v1.SensorsService/GetSensors',
      ($0.GetSensorsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetSensorsResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetSensorsResponse> getSensors($0.GetSensorsRequest request, {$grpc.CallOptions? options}) {
...
abstract class SensorsServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.GetSensorsResponse> getSensors_Pre($grpc.ServiceCall call, $async.Future<$0.GetSensorsRequest> request) async {
  ...
  $async.Future<$0.GetSensorsResponse> getSensors($grpc.ServiceCall call, $0.GetSensorsRequest request);

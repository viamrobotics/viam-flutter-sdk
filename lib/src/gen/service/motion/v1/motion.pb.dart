...
class MoveRequest extends $pb.GeneratedMessage {
  factory MoveRequest({
    $core.String? name,
    $13.PoseInFrame? destination,
    $13.ResourceName? componentName,
    $13.WorldState? worldState,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MoveRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.service.motion.v1'), createEmptyInstance: create)
    ...
    ..aOM<$13.PoseInFrame>(2, _omitFieldNames ? '' : 'destination', subBuilder: $13.PoseInFrame.create)
    ..aOM<$13.ResourceName>(3, _omitFieldNames ? '' : 'componentName', subBuilder: $13.ResourceName.create)
    ..aOM<$13.WorldState>(4, _omitFieldNames ? '' : 'worldState', subBuilder: $13.WorldState.create)
  ...
  @$pb.TagNumber(2)
  $13.PoseInFrame get destination => $_getN(1);
  @$pb.TagNumber(2)
  set destination($13.PoseInFrame v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDestination() => $_has(1);
  @$pb.TagNumber(2)
  void clearDestination() => clearField(2);
  @$pb.TagNumber(2)
  $13.PoseInFrame ensureDestination() => $_ensure(1);

  /// Component on the robot to move to the specified destination
  @$pb.TagNumber(3)
  $13.ResourceName get componentName => $_getN(2);
  @$pb.TagNumber(3)
  set componentName($13.ResourceName v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasComponentName() => $_has(2);
  @$pb.TagNumber(3)
  void clearComponentName() => clearField(3);
  @$pb.TagNumber(3)
  $13.ResourceName ensureComponentName() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $13.WorldState get worldState => $_getN(3);
  @$pb.TagNumber(4)
  set worldState($13.WorldState v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasWorldState() => $_has(3);
  @$pb.TagNumber(4)
  void clearWorldState() => clearField(4);
  @$pb.TagNumber(4)
  $13.WorldState ensureWorldState() => $_ensure(3);
  ...
  @$pb.TagNumber(99)
  $42.Struct ensureExtra() => $_ensure(5);
}
...
class MoveOnMapRequest extends $pb.GeneratedMessage {
  factory MoveOnMapRequest({
    ...
    $13.Pose? destination,
    $13.ResourceName? componentName,
    $13.ResourceName? slamServiceName,
    MotionConfiguration? motionConfiguration,
    $core.Iterable<$13.Geometry>? obstacles,
    $42.Struct? extra,
  }) {
    final $result = create();
    if (name != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MoveOnMapRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.service.motion.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$13.Pose>(2, _omitFieldNames ? '' : 'destination', subBuilder: $13.Pose.create)
    ..aOM<$13.ResourceName>(3, _omitFieldNames ? '' : 'componentName', subBuilder: $13.ResourceName.create)
    ..aOM<$13.ResourceName>(4, _omitFieldNames ? '' : 'slamServiceName', subBuilder: $13.ResourceName.create)
    ..aOM<MotionConfiguration>(5, _omitFieldNames ? '' : 'motionConfiguration', subBuilder: MotionConfiguration.create)
    ..pc<$13.Geometry>(6, _omitFieldNames ? '' : 'obstacles', $pb.PbFieldType.PM, subBuilder: $13.Geometry.create)
    ..aOM<$42.Struct>(99, _omitFieldNames ? '' : 'extra', subBuilder: $42.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $13.Pose get destination => $_getN(1);
  @$pb.TagNumber(2)
  set destination($13.Pose v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDestination() => $_has(1);
  @$pb.TagNumber(2)
  void clearDestination() => clearField(2);
  @$pb.TagNumber(2)
  $13.Pose ensureDestination() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $13.ResourceName get slamServiceName => $_getN(3);
  @$pb.TagNumber(4)
  set slamServiceName($13.ResourceName v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSlamServiceName() => $_has(3);
  @$pb.TagNumber(4)
  void clearSlamServiceName() => clearField(4);
  @$pb.TagNumber(4)
  $13.ResourceName ensureSlamServiceName() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $core.List<$13.Geometry> get obstacles => $_getList(5);

  /// Additional arguments to the method
  @$pb.TagNumber(99)
  $42.Struct get extra => $_getN(6);
  @$pb.TagNumber(99)
  set extra($42.Struct v) { setField(99, v); }
  @$pb.TagNumber(99)
  ...
  void clearExtra() => clearField(99);
  @$pb.TagNumber(99)
  $42.Struct ensureExtra() => $_ensure(6);
}
...
class ObstacleDetector extends $pb.GeneratedMessage {
  factory ObstacleDetector({
    $13.ResourceName? visionService,
    $13.ResourceName? camera,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ObstacleDetector', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.service.motion.v1'), createEmptyInstance: create)
    ..aOM<$13.ResourceName>(1, _omitFieldNames ? '' : 'visionService', subBuilder: $13.ResourceName.create)
    ..aOM<$13.ResourceName>(2, _omitFieldNames ? '' : 'camera', subBuilder: $13.ResourceName.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $13.ResourceName get visionService => $_getN(0);
  @$pb.TagNumber(1)
  set visionService($13.ResourceName v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasVisionService() => $_has(0);
  @$pb.TagNumber(1)
  void clearVisionService() => clearField(1);
  @$pb.TagNumber(1)
  $13.ResourceName ensureVisionService() => $_ensure(0);

  @$pb.TagNumber(2)
  $13.ResourceName get camera => $_getN(1);
  @$pb.TagNumber(2)
  set camera($13.ResourceName v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCamera() => $_has(1);
  @$pb.TagNumber(2)
  void clearCamera() => clearField(2);
  @$pb.TagNumber(2)
  $13.ResourceName ensureCamera() => $_ensure(1);
}
...
class MoveOnGlobeRequest extends $pb.GeneratedMessage {
  factory MoveOnGlobeRequest({
    $core.String? name,
    $13.GeoPoint? destination,
    $core.double? heading,
    $13.ResourceName? componentName,
    $13.ResourceName? movementSensorName,
    $core.Iterable<$13.GeoGeometry>? obstacles,
    MotionConfiguration? motionConfiguration,
    $core.Iterable<$13.GeoGeometry>? boundingRegions,
    $42.Struct? extra,
  }) {
    final $result = create();
    if (name != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MoveOnGlobeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.service.motion.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$13.GeoPoint>(2, _omitFieldNames ? '' : 'destination', subBuilder: $13.GeoPoint.create)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'heading', $pb.PbFieldType.OD)
    ..aOM<$13.ResourceName>(4, _omitFieldNames ? '' : 'componentName', subBuilder: $13.ResourceName.create)
    ..aOM<$13.ResourceName>(5, _omitFieldNames ? '' : 'movementSensorName', subBuilder: $13.ResourceName.create)
    ..pc<$13.GeoGeometry>(6, _omitFieldNames ? '' : 'obstacles', $pb.PbFieldType.PM, subBuilder: $13.GeoGeometry.create)
    ..aOM<MotionConfiguration>(7, _omitFieldNames ? '' : 'motionConfiguration', subBuilder: MotionConfiguration.create)
    ..pc<$13.GeoGeometry>(8, _omitFieldNames ? '' : 'boundingRegions', $pb.PbFieldType.PM, subBuilder: $13.GeoGeometry.create)
    ..aOM<$42.Struct>(99, _omitFieldNames ? '' : 'extra', subBuilder: $42.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $13.GeoPoint get destination => $_getN(1);
  @$pb.TagNumber(2)
  set destination($13.GeoPoint v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDestination() => $_has(1);
  @$pb.TagNumber(2)
  void clearDestination() => clearField(2);
  @$pb.TagNumber(2)
  $13.GeoPoint ensureDestination() => $_ensure(1);
  ...
  /// Component on the robot to move to the specified destination
  @$pb.TagNumber(4)
  $13.ResourceName get componentName => $_getN(3);
  @$pb.TagNumber(4)
  set componentName($13.ResourceName v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasComponentName() => $_has(3);
  @$pb.TagNumber(4)
  void clearComponentName() => clearField(4);
  @$pb.TagNumber(4)
  $13.ResourceName ensureComponentName() => $_ensure(3);

  /// Name of the movement sensor which will be used to check robot location
  @$pb.TagNumber(5)
  $13.ResourceName get movementSensorName => $_getN(4);
  @$pb.TagNumber(5)
  set movementSensorName($13.ResourceName v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMovementSensorName() => $_has(4);
  @$pb.TagNumber(5)
  void clearMovementSensorName() => clearField(5);
  @$pb.TagNumber(5)
  $13.ResourceName ensureMovementSensorName() => $_ensure(4);

  /// Obstacles to be considered for motion planning
  @$pb.TagNumber(6)
  $core.List<$13.GeoGeometry> get obstacles => $_getList(5);
  ...
  @$pb.TagNumber(8)
  $core.List<$13.GeoGeometry> get boundingRegions => $_getList(7);

  /// Additional arguments to the method
  @$pb.TagNumber(99)
  $42.Struct get extra => $_getN(8);
  @$pb.TagNumber(99)
  set extra($42.Struct v) { setField(99, v); }
  @$pb.TagNumber(99)
  ...
  void clearExtra() => clearField(99);
  @$pb.TagNumber(99)
  $42.Struct ensureExtra() => $_ensure(8);
}
...
class GetPoseRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPoseRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.service.motion.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$13.ResourceName>(2, _omitFieldNames ? '' : 'componentName', subBuilder: $13.ResourceName.create)
    ..aOS(3, _omitFieldNames ? '' : 'destinationFrame')
    ..pc<$13.Transform>(4, _omitFieldNames ? '' : 'supplementalTransforms', $pb.PbFieldType.PM, subBuilder: $13.Transform.create)
    ..aOM<$42.Struct>(99, _omitFieldNames ? '' : 'extra', subBuilder: $42.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $13.ResourceName get componentName => $_getN(1);
  @$pb.TagNumber(2)
  set componentName($13.ResourceName v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasComponentName() => $_has(1);
  @$pb.TagNumber(2)
  void clearComponentName() => clearField(2);
  @$pb.TagNumber(2)
  $13.ResourceName ensureComponentName() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $core.List<$13.Transform> get supplementalTransforms => $_getList(3);
...
class PlanStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlanStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.service.motion.v1'), createEmptyInstance: create)
    ...
    ..aOM<$43.Timestamp>(2, _omitFieldNames ? '' : 'timestamp', subBuilder: $43.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $43.Timestamp get timestamp => $_getN(1);
  @$pb.TagNumber(2)
  set timestamp($43.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTimestamp() => $_has(1);
  @$pb.TagNumber(2)
  void clearTimestamp() => clearField(2);
  @$pb.TagNumber(2)
  $43.Timestamp ensureTimestamp() => $_ensure(1);

...
class MoveOnMapRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  $core.bool hasComponentName() => $_has(6);
  @$pb.TagNumber(7)
  void clearComponentName() => clearField(7);

  /// Name of the slam service from which the SLAM map is requested
  @$pb.TagNumber(8)
  $core.String get slamServiceName => $_getSZ(7);
  @$pb.TagNumber(8)
  set slamServiceName($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasSlamServiceName() => $_has(7);
  @$pb.TagNumber(8)
  void clearSlamServiceName() => clearField(8);

  /// Additional arguments to the method
  @$pb.TagNumber(99)
  $51.Struct get extra => $_getN(8);
  @$pb.TagNumber(99)
  set extra($51.Struct v) { setField(99, v); }
  @$pb.TagNumber(99)
  ...
  void clearExtra() => clearField(99);
  @$pb.TagNumber(99)
  $51.Struct ensureExtra() => $_ensure(8);
}
...
class ObstacleDetector extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    final $result = create();
    if (visionServiceDeprecated != null) {
      // ignore: deprecated_member_use_from_same_package
      $result.visionServiceDeprecated = visionServiceDeprecated;
    }
    if (cameraDeprecated != null) {
      // ignore: deprecated_member_use_from_same_package
      $result.cameraDeprecated = cameraDeprecated;
    }
  ...
  @$pb.TagNumber(3)
  set visionService($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasVisionService() => $_has(2);
  @$pb.TagNumber(3)
  void clearVisionService() => clearField(3);

  @$pb.TagNumber(4)
  $core.String get camera => $_getSZ(3);
  @$pb.TagNumber(4)
  set camera($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
...
class MoveOnGlobeRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (movementSensorNameDeprecated != null) {
      // ignore: deprecated_member_use_from_same_package
      $result.movementSensorNameDeprecated = movementSensorNameDeprecated;
    }
    if (obstacles != null) {
      $result.obstacles.addAll(obstacles);
    }
  ...
  @$pb.TagNumber(10)
  $core.String get movementSensorName => $_getSZ(9);
  @$pb.TagNumber(10)
  set movementSensorName($core.String v) { $_setString(9, v); }
  @$pb.TagNumber(10)
  $core.bool hasMovementSensorName() => $_has(9);
  @$pb.TagNumber(10)
  void clearMovementSensorName() => clearField(10);

  /// Additional arguments to the method
  @$pb.TagNumber(99)
  $51.Struct get extra => $_getN(10);
  @$pb.TagNumber(99)
  set extra($51.Struct v) { setField(99, v); }
  @$pb.TagNumber(99)
  ...
  void clearExtra() => clearField(99);
  @$pb.TagNumber(99)
  $51.Struct ensureExtra() => $_ensure(10);
}
...
class PlanStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlanStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.service.motion.v1'), createEmptyInstance: create)
    ...
    ..aOM<$52.Timestamp>(2, _omitFieldNames ? '' : 'timestamp', subBuilder: $52.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $52.Timestamp get timestamp => $_getN(1);
  @$pb.TagNumber(2)
  set timestamp($52.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTimestamp() => $_has(1);
  @$pb.TagNumber(2)
  void clearTimestamp() => clearField(2);
  @$pb.TagNumber(2)
  $52.Timestamp ensureTimestamp() => $_ensure(1);

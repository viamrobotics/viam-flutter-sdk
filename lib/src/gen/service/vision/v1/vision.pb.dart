...
import '../../../component/camera/v1/camera.pb.dart' as $21;
...
class CaptureAllFromCameraResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CaptureAllFromCameraResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.service.vision.v1'), createEmptyInstance: create)
    ..aOM<$21.Image>(1, _omitFieldNames ? '' : 'image', subBuilder: $21.Image.create)
  ...
  @$pb.TagNumber(1)
  $21.Image get image => $_getN(0);
  @$pb.TagNumber(1)
  set image($21.Image v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasImage() => $_has(0);
  @$pb.TagNumber(1)
  void clearImage() => clearField(1);
  @$pb.TagNumber(1)
  $21.Image ensureImage() => $_ensure(0);

...
class MotorServiceClient extends $grpc.Client {
  ...
  static final _$resetZeroPosition = $grpc.ClientMethod<
          $0.ResetZeroPositionRequest, $0.ResetZeroPositionResponse>(
      '/viam.component.motor.v1.MotorService/ResetZeroPosition',
      ($0.ResetZeroPositionRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.ResetZeroPositionResponse.fromBuffer(value));
  ...
  static final _$isPowered =
      $grpc.ClientMethod<$0.IsPoweredRequest, $0.IsPoweredResponse>(
          '/viam.component.motor.v1.MotorService/IsPowered',
          ($0.IsPoweredRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.IsPoweredResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GoForResponse> goFor($0.GoForRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$goFor, request, options: options);
  }

  $grpc.ResponseFuture<$0.GoToResponse> goTo($0.GoToRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$goTo, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResetZeroPositionResponse> resetZeroPosition(
      $0.ResetZeroPositionRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.IsPoweredResponse> isPowered(
      $0.IsPoweredRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class MotorServiceBase extends $grpc.Service {
  ...
  MotorServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ResetZeroPositionRequest,
            $0.ResetZeroPositionResponse>(
        'ResetZeroPosition',
        resetZeroPosition_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ResetZeroPositionRequest.fromBuffer(value),
  ...
  $async.Future<$0.GoForResponse> goFor_Pre(
      $grpc.ServiceCall call, $async.Future<$0.GoForRequest> request) async {
    return goFor(call, await request);
  }

  $async.Future<$0.GoToResponse> goTo_Pre(
      $grpc.ServiceCall call, $async.Future<$0.GoToRequest> request) async {
    return goTo(call, await request);
  }

  $async.Future<$0.ResetZeroPositionResponse> resetZeroPosition_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ResetZeroPositionRequest> request) async {
  ...
  $async.Future<$0.IsPoweredResponse> isPowered_Pre($grpc.ServiceCall call,
      $async.Future<$0.IsPoweredRequest> request) async {
  ...
  $async.Future<$0.GoForResponse> goFor(
      $grpc.ServiceCall call, $0.GoForRequest request);
  $async.Future<$0.GoToResponse> goTo(
      $grpc.ServiceCall call, $0.GoToRequest request);
  $async.Future<$0.ResetZeroPositionResponse> resetZeroPosition(
      $grpc.ServiceCall call, $0.ResetZeroPositionRequest request);
  ...
  $async.Future<$0.IsPoweredResponse> isPowered(
      $grpc.ServiceCall call, $0.IsPoweredRequest request);

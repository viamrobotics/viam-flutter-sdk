...
class PoseTrackerServiceClient extends $grpc.Client {
  static final _$getPoses = $grpc.ClientMethod<$0.GetPosesRequest, $0.GetPosesResponse>(
      '/viam.component.posetracker.v1.PoseTrackerService/GetPoses',
      ($0.GetPosesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetPosesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetPosesResponse> getPoses($0.GetPosesRequest request, {$grpc.CallOptions? options}) {
...
abstract class PoseTrackerServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.GetPosesResponse> getPoses_Pre($grpc.ServiceCall call, $async.Future<$0.GetPosesRequest> request) async {
  ...
  $async.Future<$0.GetPosesResponse> getPoses($grpc.ServiceCall call, $0.GetPosesRequest request);

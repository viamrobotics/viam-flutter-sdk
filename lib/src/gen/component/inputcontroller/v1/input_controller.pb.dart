...
class Event extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Event', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.component.inputcontroller.v1'), createEmptyInstance: create)
    ..aOM<$43.Timestamp>(1, _omitFieldNames ? '' : 'time', subBuilder: $43.Timestamp.create)
  ...
  /// Timestamp of event
  @$pb.TagNumber(1)
  $43.Timestamp get time => $_getN(0);
  @$pb.TagNumber(1)
  set time($43.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearTime() => clearField(1);
  @$pb.TagNumber(1)
  $43.Timestamp ensureTime() => $_ensure(0);

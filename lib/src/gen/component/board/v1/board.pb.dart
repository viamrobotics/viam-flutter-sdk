...
class SetPowerModeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetPowerModeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.component.board.v1'), createEmptyInstance: create)
    ...
    ..aOM<$50.Duration>(3, _omitFieldNames ? '' : 'duration', subBuilder: $50.Duration.create)
    ..aOM<$51.Struct>(99, _omitFieldNames ? '' : 'extra', subBuilder: $51.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $50.Duration get duration => $_getN(2);
  @$pb.TagNumber(3)
  set duration($50.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDuration() => $_has(2);
  @$pb.TagNumber(3)
  void clearDuration() => clearField(3);
  @$pb.TagNumber(3)
  $50.Duration ensureDuration() => $_ensure(2);

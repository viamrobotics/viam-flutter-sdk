...
class GenericServiceClient extends $grpc.Client {
  static final _$doCommand =
      $grpc.ClientMethod<$0.DoCommandRequest, $0.DoCommandResponse>(
  ...
  $grpc.ResponseFuture<$0.DoCommandResponse> doCommand(
...
abstract class GenericServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.DoCommandResponse> doCommand_Pre($grpc.ServiceCall call,
      $async.Future<$0.DoCommandRequest> request) async {

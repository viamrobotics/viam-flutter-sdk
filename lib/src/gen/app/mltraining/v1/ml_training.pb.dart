...
class TrainingJobMetadata extends $pb.GeneratedMessage {
  factory TrainingJobMetadata({
    ...
    $43.Timestamp? lastModified,
    $core.String? syncedModelId,
    $core.String? id,
    $45.Status? errorStatus,
    $43.Timestamp? trainingStarted,
    $43.Timestamp? trainingEnded,
    $core.String? datasetId,
    $core.String? organizationId,
    $core.String? modelName,
    $core.String? modelVersion,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainingJobMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.mltraining.v1'), createEmptyInstance: create)
    ...
    ..aOM<$43.Timestamp>(4, _omitFieldNames ? '' : 'lastModified', subBuilder: $43.Timestamp.create)
    ..aOS(5, _omitFieldNames ? '' : 'syncedModelId')
    ..aOS(7, _omitFieldNames ? '' : 'id')
    ..aOM<$45.Status>(8, _omitFieldNames ? '' : 'errorStatus', subBuilder: $45.Status.create)
    ..aOM<$43.Timestamp>(9, _omitFieldNames ? '' : 'trainingStarted', subBuilder: $43.Timestamp.create)
    ..aOM<$43.Timestamp>(10, _omitFieldNames ? '' : 'trainingEnded', subBuilder: $43.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $43.Timestamp get lastModified => $_getN(2);
  @$pb.TagNumber(4)
  set lastModified($43.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastModified() => $_has(2);
  @$pb.TagNumber(4)
  void clearLastModified() => clearField(4);
  @$pb.TagNumber(4)
  $43.Timestamp ensureLastModified() => $_ensure(2);
  ...
  @$pb.TagNumber(8)
  $45.Status get errorStatus => $_getN(5);
  @$pb.TagNumber(8)
  set errorStatus($45.Status v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasErrorStatus() => $_has(5);
  @$pb.TagNumber(8)
  void clearErrorStatus() => clearField(8);
  @$pb.TagNumber(8)
  $45.Status ensureErrorStatus() => $_ensure(5);

  @$pb.TagNumber(9)
  $43.Timestamp get trainingStarted => $_getN(6);
  @$pb.TagNumber(9)
  set trainingStarted($43.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTrainingStarted() => $_has(6);
  @$pb.TagNumber(9)
  void clearTrainingStarted() => clearField(9);
  @$pb.TagNumber(9)
  $43.Timestamp ensureTrainingStarted() => $_ensure(6);

  @$pb.TagNumber(10)
  $43.Timestamp get trainingEnded => $_getN(7);
  @$pb.TagNumber(10)
  set trainingEnded($43.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasTrainingEnded() => $_has(7);
  @$pb.TagNumber(10)
  void clearTrainingEnded() => clearField(10);
  @$pb.TagNumber(10)
  $43.Timestamp ensureTrainingEnded() => $_ensure(7);
...
class TrainingJobLogEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainingJobLogEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.mltraining.v1'), createEmptyInstance: create)
    ...
    ..aOM<$43.Timestamp>(2, _omitFieldNames ? '' : 'time', subBuilder: $43.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $43.Timestamp get time => $_getN(1);
  @$pb.TagNumber(2)
  set time($43.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearTime() => clearField(2);
  @$pb.TagNumber(2)
  $43.Timestamp ensureTime() => $_ensure(1);

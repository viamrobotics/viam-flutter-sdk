...
class MLTrainingServiceClient extends $grpc.Client {
  static final _$submitTrainingJob = $grpc.ClientMethod<
          $1.SubmitTrainingJobRequest, $1.SubmitTrainingJobResponse>(
      '/viam.app.mltraining.v1.MLTrainingService/SubmitTrainingJob',
      ($1.SubmitTrainingJobRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $1.SubmitTrainingJobResponse.fromBuffer(value));
  static final _$getTrainingJob =
      $grpc.ClientMethod<$1.GetTrainingJobRequest, $1.GetTrainingJobResponse>(
          '/viam.app.mltraining.v1.MLTrainingService/GetTrainingJob',
          ($1.GetTrainingJobRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.GetTrainingJobResponse.fromBuffer(value));
  static final _$listTrainingJobs = $grpc.ClientMethod<
          $1.ListTrainingJobsRequest, $1.ListTrainingJobsResponse>(
  ...
  $grpc.ResponseFuture<$1.SubmitTrainingJobResponse> submitTrainingJob(
      $1.SubmitTrainingJobRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$submitTrainingJob, request, options: options);
  }

  $grpc.ResponseFuture<$1.GetTrainingJobResponse> getTrainingJob(
      $1.GetTrainingJobRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getTrainingJob, request, options: options);
  }

  $grpc.ResponseFuture<$1.ListTrainingJobsResponse> listTrainingJobs(
...
abstract class MLTrainingServiceBase extends $grpc.Service {
  ...
  MLTrainingServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.SubmitTrainingJobRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.SubmitTrainingJobRequest.fromBuffer(value),
        ($1.SubmitTrainingJobResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.GetTrainingJobRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.GetTrainingJobRequest.fromBuffer(value),
        ($1.GetTrainingJobResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.ListTrainingJobsRequest,
  ...
  $async.Future<$1.SubmitTrainingJobResponse> submitTrainingJob_Pre(
      ...
      $async.Future<$1.SubmitTrainingJobRequest> request) async {
    return submitTrainingJob(call, await request);
  }

  $async.Future<$1.GetTrainingJobResponse> getTrainingJob_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.GetTrainingJobRequest> request) async {
    return getTrainingJob(call, await request);
  }

  $async.Future<$1.ListTrainingJobsResponse> listTrainingJobs_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.ListTrainingJobsRequest> request) async {

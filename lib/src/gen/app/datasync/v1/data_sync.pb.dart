...
class SensorMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SensorMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.datasync.v1'), createEmptyInstance: create)
    ..aOM<$50.Timestamp>(1, _omitFieldNames ? '' : 'timeRequested', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(2, _omitFieldNames ? '' : 'timeReceived', subBuilder: $50.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $50.Timestamp get timeRequested => $_getN(0);
  @$pb.TagNumber(1)
  set timeRequested($50.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTimeRequested() => $_has(0);
  @$pb.TagNumber(1)
  void clearTimeRequested() => clearField(1);
  @$pb.TagNumber(1)
  $50.Timestamp ensureTimeRequested() => $_ensure(0);

  @$pb.TagNumber(2)
  $50.Timestamp get timeReceived => $_getN(1);
  @$pb.TagNumber(2)
  set timeReceived($50.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTimeReceived() => $_has(1);
  @$pb.TagNumber(2)
  void clearTimeReceived() => clearField(2);
  @$pb.TagNumber(2)
  $50.Timestamp ensureTimeReceived() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  set annotations($4.Annotations v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class SensorData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SensorData', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.datasync.v1'), createEmptyInstance: create)
    ...
    ..aOM<$49.Struct>(2, _omitFieldNames ? '' : 'struct', subBuilder: $49.Struct.create)
  ...
  @$pb.TagNumber(2)
  $49.Struct get struct => $_getN(1);
  @$pb.TagNumber(2)
  set struct($49.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStruct() => $_has(1);
  @$pb.TagNumber(2)
  void clearStruct() => clearField(2);
  @$pb.TagNumber(2)
  $49.Struct ensureStruct() => $_ensure(1);
...
class UploadMetadata extends $pb.GeneratedMessage {
  factory UploadMetadata({
    ...
    $50.Timestamp? fileCreateTime,
    $50.Timestamp? fileModifyTime,
  }) {
    final $result = create();
    if (partId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.datasync.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $51.Any>(8, _omitFieldNames ? '' : 'methodParameters', entryClassName: 'UploadMetadata.MethodParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $51.Any.create, valueDefaultOrMaker: $51.Any.getDefault, packageName: const $pb.PackageName('viam.app.datasync.v1'))
    ...
    ..aOM<$50.Timestamp>(14, _omitFieldNames ? '' : 'fileCreateTime', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(15, _omitFieldNames ? '' : 'fileModifyTime', subBuilder: $50.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.Map<$core.String, $51.Any> get methodParameters => $_getMap(6);
  ...
  @$pb.TagNumber(14)
  $50.Timestamp get fileCreateTime => $_getN(11);
  @$pb.TagNumber(14)
  set fileCreateTime($50.Timestamp v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasFileCreateTime() => $_has(11);
  @$pb.TagNumber(14)
  void clearFileCreateTime() => clearField(14);
  @$pb.TagNumber(14)
  $50.Timestamp ensureFileCreateTime() => $_ensure(11);

  @$pb.TagNumber(15)
  $50.Timestamp get fileModifyTime => $_getN(12);
  @$pb.TagNumber(15)
  set fileModifyTime($50.Timestamp v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasFileModifyTime() => $_has(12);
  @$pb.TagNumber(15)
  void clearFileModifyTime() => clearField(15);
  @$pb.TagNumber(15)
  $50.Timestamp ensureFileModifyTime() => $_ensure(12);
}
...
class DataCaptureMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataCaptureMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.datasync.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $51.Any>(6, _omitFieldNames ? '' : 'methodParameters', entryClassName: 'DataCaptureMetadata.MethodParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $51.Any.create, valueDefaultOrMaker: $51.Any.getDefault, packageName: const $pb.PackageName('viam.app.datasync.v1'))
  ...
  @$pb.TagNumber(6)
  $core.Map<$core.String, $51.Any> get methodParameters => $_getMap(4);

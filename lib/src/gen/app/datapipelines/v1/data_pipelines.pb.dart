...
class DataPipeline extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataPipeline', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.datapipelines.v1'), createEmptyInstance: create)
    ...
    ..aOM<$50.Timestamp>(8, _omitFieldNames ? '' : 'updatedAt', subBuilder: $50.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $50.Timestamp get updatedAt => $_getN(7);
  @$pb.TagNumber(8)
  set updatedAt($50.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasUpdatedAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearUpdatedAt() => clearField(8);
  @$pb.TagNumber(8)
  $50.Timestamp ensureUpdatedAt() => $_ensure(7);

  /// The type of data source for the pipeline. If not specified, default is standard data storage.
  @$pb.TagNumber(9)
  $4.TabularDataSourceType get dataSourceType => $_getN(8);
  @$pb.TagNumber(9)
  set dataSourceType($4.TabularDataSourceType v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class CreateDataPipelineRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDataPipelineRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.datapipelines.v1'), createEmptyInstance: create)
    ...
    ..e<$4.TabularDataSourceType>(6, _omitFieldNames ? '' : 'dataSourceType', $pb.PbFieldType.OE, defaultOrMaker: $4.TabularDataSourceType.TABULAR_DATA_SOURCE_TYPE_UNSPECIFIED, valueOf: $4.TabularDataSourceType.valueOf, enumValues: $4.TabularDataSourceType.values)
    ..hasRequiredFields = false
  ;
  ...
  /// The type of data source for the pipeline. If not specified, default is standard data storage.
  @$pb.TagNumber(6)
  $4.TabularDataSourceType get dataSourceType => $_getN(5);
  @$pb.TagNumber(6)
  set dataSourceType($4.TabularDataSourceType v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class DataPipelineRun extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataPipelineRun', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.datapipelines.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOM<$50.Timestamp>(2, _omitFieldNames ? '' : 'startTime', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(3, _omitFieldNames ? '' : 'endTime', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(4, _omitFieldNames ? '' : 'dataStartTime', subBuilder: $50.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  set startTime($50.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set endTime($50.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $50.Timestamp get dataStartTime => $_getN(3);
  @$pb.TagNumber(4)
  set dataStartTime($50.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDataStartTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearDataStartTime() => clearField(4);
  @$pb.TagNumber(4)
  $50.Timestamp ensureDataStartTime() => $_ensure(3);

  /// The end time of the data that was processed in the run.
  @$pb.TagNumber(5)
  $50.Timestamp get dataEndTime => $_getN(4);
  @$pb.TagNumber(5)
  set dataEndTime($50.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDataEndTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearDataEndTime() => clearField(5);
  @$pb.TagNumber(5)
  $50.Timestamp ensureDataEndTime() => $_ensure(4);

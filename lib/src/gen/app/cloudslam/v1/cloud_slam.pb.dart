...
class StartMappingSessionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StartMappingSessionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.cloudslam.v1'), createEmptyInstance: create)
    ...
    ..aOM<$49.Struct>(10, _omitFieldNames ? '' : 'slamConfig', subBuilder: $49.Struct.create)
  ...
  @$pb.TagNumber(10)
  $49.Struct get slamConfig => $_getN(8);
  @$pb.TagNumber(10)
  set slamConfig($49.Struct v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasSlamConfig() => $_has(8);
  @$pb.TagNumber(10)
  void clearSlamConfig() => clearField(10);
  @$pb.TagNumber(10)
  $49.Struct ensureSlamConfig() => $_ensure(8);
...
class CaptureInterval extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CaptureInterval', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.cloudslam.v1'), createEmptyInstance: create)
    ..aOM<$50.Timestamp>(1, _omitFieldNames ? '' : 'startTime', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(2, _omitFieldNames ? '' : 'endTime', subBuilder: $50.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set startTime($50.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set endTime($50.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class GetMappingSessionPointCloudResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetMappingSessionPointCloudResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.cloudslam.v1'), createEmptyInstance: create)
    ...
    ..aOM<$9.Pose>(2, _omitFieldNames ? '' : 'pose', subBuilder: $9.Pose.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $9.Pose get pose => $_getN(1);
  @$pb.TagNumber(2)
  set pose($9.Pose v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPose() => $_has(1);
  @$pb.TagNumber(2)
  void clearPose() => clearField(2);
  @$pb.TagNumber(2)
  $9.Pose ensurePose() => $_ensure(1);
}
...
class MappingMetadata extends $pb.GeneratedMessage {
  factory MappingMetadata({
    ...
    $core.String? locationId,
    $core.String? robotId,
    $50.Timestamp? timeStartSubmitted,
    $50.Timestamp? timeCloudRunJobStarted,
    $50.Timestamp? timeEndSubmitted,
    $50.Timestamp? timeCloudRunJobEnded,
    EndStatus? endStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MappingMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.cloudslam.v1'), createEmptyInstance: create)
    ...
    ..aOM<$50.Timestamp>(4, _omitFieldNames ? '' : 'timeStartSubmitted', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(5, _omitFieldNames ? '' : 'timeCloudRunJobStarted', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(6, _omitFieldNames ? '' : 'timeEndSubmitted', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(7, _omitFieldNames ? '' : 'timeCloudRunJobEnded', subBuilder: $50.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $50.Timestamp get timeStartSubmitted => $_getN(3);
  @$pb.TagNumber(4)
  set timeStartSubmitted($50.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTimeStartSubmitted() => $_has(3);
  @$pb.TagNumber(4)
  void clearTimeStartSubmitted() => clearField(4);
  @$pb.TagNumber(4)
  $50.Timestamp ensureTimeStartSubmitted() => $_ensure(3);

  @$pb.TagNumber(5)
  $50.Timestamp get timeCloudRunJobStarted => $_getN(4);
  @$pb.TagNumber(5)
  set timeCloudRunJobStarted($50.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTimeCloudRunJobStarted() => $_has(4);
  @$pb.TagNumber(5)
  void clearTimeCloudRunJobStarted() => clearField(5);
  @$pb.TagNumber(5)
  $50.Timestamp ensureTimeCloudRunJobStarted() => $_ensure(4);

  @$pb.TagNumber(6)
  $50.Timestamp get timeEndSubmitted => $_getN(5);
  @$pb.TagNumber(6)
  set timeEndSubmitted($50.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTimeEndSubmitted() => $_has(5);
  @$pb.TagNumber(6)
  void clearTimeEndSubmitted() => clearField(6);
  @$pb.TagNumber(6)
  $50.Timestamp ensureTimeEndSubmitted() => $_ensure(5);

  @$pb.TagNumber(7)
  $50.Timestamp get timeCloudRunJobEnded => $_getN(6);
  @$pb.TagNumber(7)
  set timeCloudRunJobEnded($50.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasTimeCloudRunJobEnded() => $_has(6);
  @$pb.TagNumber(7)
  void clearTimeCloudRunJobEnded() => clearField(7);
  @$pb.TagNumber(7)
  $50.Timestamp ensureTimeCloudRunJobEnded() => $_ensure(6);

...
class ComponentConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ComponentConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$46.Struct>(8, _omitFieldNames ? '' : 'attributes', subBuilder: $46.Struct.create)
  ...
  @$pb.TagNumber(8)
  $46.Struct get attributes => $_getN(7);
  @$pb.TagNumber(8)
  set attributes($46.Struct v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasAttributes() => $_has(7);
  @$pb.TagNumber(8)
  void clearAttributes() => clearField(8);
  @$pb.TagNumber(8)
  $46.Struct ensureAttributes() => $_ensure(7);
...
class ResourceLevelServiceConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceLevelServiceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$46.Struct>(2, _omitFieldNames ? '' : 'attributes', subBuilder: $46.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $46.Struct get attributes => $_getN(1);
  @$pb.TagNumber(2)
  set attributes($46.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAttributes() => $_has(1);
  @$pb.TagNumber(2)
  void clearAttributes() => clearField(2);
  @$pb.TagNumber(2)
  $46.Struct ensureAttributes() => $_ensure(1);
}
...
class ProcessConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$45.Duration>(8, _omitFieldNames ? '' : 'stopTimeout', subBuilder: $45.Duration.create)
  ...
  @$pb.TagNumber(8)
  $45.Duration get stopTimeout => $_getN(7);
  @$pb.TagNumber(8)
  set stopTimeout($45.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasStopTimeout() => $_has(7);
  @$pb.TagNumber(8)
  void clearStopTimeout() => clearField(8);
  @$pb.TagNumber(8)
  $45.Duration ensureStopTimeout() => $_ensure(7);
...
class ServiceConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $46.Struct get attributes => $_getN(3);
  @$pb.TagNumber(4)
  set attributes($46.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class SessionsConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionsConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ..aOM<$45.Duration>(1, _omitFieldNames ? '' : 'heartbeatWindow', subBuilder: $45.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $45.Duration get heartbeatWindow => $_getN(0);
  @$pb.TagNumber(1)
  set heartbeatWindow($45.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class JWKSFile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JWKSFile', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ..aOM<$46.Struct>(1, _omitFieldNames ? '' : 'json', subBuilder: $46.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $46.Struct get json => $_getN(0);
  @$pb.TagNumber(1)
  set json($46.Struct v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasJson() => $_has(0);
  @$pb.TagNumber(1)
  void clearJson() => clearField(1);
  @$pb.TagNumber(1)
  $46.Struct ensureJson() => $_ensure(0);
}
...
class AuthHandlerConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthHandlerConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$46.Struct>(5, _omitFieldNames ? '' : 'config', subBuilder: $46.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set config($46.Struct v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class RemoteConfig extends $pb.GeneratedMessage {
  factory RemoteConfig({
    ...
    $core.String? managedBy,
    $core.bool? insecure,
    $45.Duration? connectionCheckInterval,
    $45.Duration? reconnectInterval,
    $core.Iterable<ResourceLevelServiceConfig>? serviceConfigs,
    $core.String? secret,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$45.Duration>(7, _omitFieldNames ? '' : 'connectionCheckInterval', subBuilder: $45.Duration.create)
    ..aOM<$45.Duration>(8, _omitFieldNames ? '' : 'reconnectInterval', subBuilder: $45.Duration.create)
  ...
  @$pb.TagNumber(7)
  $45.Duration ensureConnectionCheckInterval() => $_ensure(6);

  @$pb.TagNumber(8)
  $45.Duration get reconnectInterval => $_getN(7);
  @$pb.TagNumber(8)
  set reconnectInterval($45.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasReconnectInterval() => $_has(7);
  @$pb.TagNumber(8)
  void clearReconnectInterval() => clearField(8);
  @$pb.TagNumber(8)
  $45.Duration ensureReconnectInterval() => $_ensure(7);
...
class NeedsRestartResponse extends $pb.GeneratedMessage {
  factory NeedsRestartResponse({
    ...
    $45.Duration? restartCheckInterval,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NeedsRestartResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$45.Duration>(3, _omitFieldNames ? '' : 'restartCheckInterval', subBuilder: $45.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $45.Duration get restartCheckInterval => $_getN(2);
  @$pb.TagNumber(3)
  set restartCheckInterval($45.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRestartCheckInterval() => $_has(2);
  @$pb.TagNumber(3)
  void clearRestartCheckInterval() => clearField(3);
  @$pb.TagNumber(3)
  $45.Duration ensureRestartCheckInterval() => $_ensure(2);
}
...
class ModuleConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModuleConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$45.Duration>(8, _omitFieldNames ? '' : 'firstRunTimeout', subBuilder: $45.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $45.Duration get firstRunTimeout => $_getN(7);
  @$pb.TagNumber(8)
  set firstRunTimeout($45.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasFirstRunTimeout() => $_has(7);
  @$pb.TagNumber(8)
  void clearFirstRunTimeout() => clearField(8);
  @$pb.TagNumber(8)
  $45.Duration ensureFirstRunTimeout() => $_ensure(7);
}

...
final $typed_data.Uint8List onlineStateDescriptor = $convert.base64Decode(
    ...
    'RBVEVfT05MSU5FEAESGAoUT05MSU5FX1NUQVRFX09GRkxJTkUQAhIfChtPTkxJTkVfU1RBVEVf'
    'QVdBSVRJTkdfU0VUVVAQAw==');
...
const Robot$json = {
  ...
  '2': [
    ...
    {'1': 'online_state', '3': 6, '4': 1, '5': 14, '6': '.viam.app.v1.OnlineState', '8': {}, '10': 'onlineState'},
    {'1': 'seconds_since_online', '3': 7, '4': 1, '5': 3, '8': {}, '10': 'secondsSinceOnline'},
  ],
};
...
final $typed_data.Uint8List robotDescriptor = $convert.base64Decode(
    ...
    'ngMRYnNvbjoiY3JlYXRlZF9vbiJSCWNyZWF0ZWRPbhJzCgxvbmxpbmVfc3RhdGUYBiABKA4yGC'
    '52aWFtLmFwcC52MS5PbmxpbmVTdGF0ZUI2moSeAzFic29uOiJvbmxpbmVfc3RhdGUiIGpzb246'
    'Im9ubGluZV9zdGF0ZSxvbWl0ZW1wdHkiUgtvbmxpbmVTdGF0ZRJ4ChRzZWNvbmRzX3NpbmNlX2'
    '9ubGluZRgHIAEoA0JGmoSeA0Fic29uOiJzZWNvbmRzX3NpbmNlX29ubGluZSIganNvbjoic2Vj'
    'b25kc19zaW5jZV9vbmxpbmUsb21pdGVtcHR5IlISc2Vjb25kc1NpbmNlT25saW5l');
...
final $typed_data.Uint8List robotPartDescriptor = $convert.base64Decode(
    ...
    '9hdCJSC2xhc3RVcGRhdGVkEnMKDG9ubGluZV9zdGF0ZRgQIAEoDjIYLnZpYW0uYXBwLnYxLk9u'
...
final $typed_data.Uint8List getOrganizationMetadataResponseDescriptor = $convert.base64Decode(
    'Ch9HZXRPcmdhbml6YXRpb25NZXRhZGF0YVJlc3BvbnNlEisKBGRhdGEYASABKAsyFy5nb29nbG'
    'UucHJvdG9idWYuU3RydWN0UgRkYXRh');
...
final $typed_data.Uint8List getLocationMetadataResponseDescriptor = $convert.base64Decode(
    'ChtHZXRMb2NhdGlvbk1ldGFkYXRhUmVzcG9uc2USKwoEZGF0YRgBIAEoCzIXLmdvb2dsZS5wcm'
    '90b2J1Zi5TdHJ1Y3RSBGRhdGE=');
...
final $typed_data.Uint8List getRobotPartHistoryRequestDescriptor = $convert.base64Decode(
    ...
    'aXSIAQESNQoFc3RhcnQYBCABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wSAJSBXN0YX'
    'J0iAEBEjEKA2VuZBgFIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBIA1IDZW5kiAEB'
    'Qg0KC19wYWdlX3Rva2VuQg0KC19wYWdlX2xpbWl0QggKBl9zdGFydEIGCgRfZW5k');
...
final $typed_data.Uint8List getRobotPartMetadataResponseDescriptor = $convert.base64Decode(
    'ChxHZXRSb2JvdFBhcnRNZXRhZGF0YVJlc3BvbnNlEisKBGRhdGEYASABKAsyFy5nb29nbGUucH'
...
final $typed_data.Uint8List updateRobotPartMetadataRequestDescriptor = $convert.base64Decode(
    'Ch5VcGRhdGVSb2JvdFBhcnRNZXRhZGF0YVJlcXVlc3QSDgoCaWQYASABKAlSAmlkEisKBGRhdG'
...
@$core.Deprecated('Use fragmentUsageDescriptor instead')
...
const ListFragmentsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'fragment_usages', '3': 2, '4': 3, '5': 11, '6': '.viam.app.v1.FragmentUsage', '10': 'fragmentUsages'},
  ],
};
...
final $typed_data.Uint8List listFragmentsResponseDescriptor = $convert.base64Decode(
    ...
    'EuRnJhZ21lbnRSCWZyYWdtZW50cxJDCg9mcmFnbWVudF91c2FnZXMYAiADKAsyGi52aWFtLmFw'
    'cC52MS5GcmFnbWVudFVzYWdlUg5mcmFnbWVudFVzYWdlcw==');
...
const PartSummary$json = {
  ...
  '2': [
    ...
    {'1': 'online_state', '3': 12, '4': 1, '5': 14, '6': '.viam.app.v1.OnlineState', '10': 'onlineState'},
    {'1': 'seconds_since_online', '3': 13, '4': 1, '5': 3, '10': 'secondsSinceOnline'},
    {'1': 'last_access', '3': 14, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '9': 0, '10': 'lastAccess', '17': true},
    {'1': 'last_online', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '9': 1, '10': 'lastOnline', '17': true},
    {'1': 'viam_server_version', '3': 4, '4': 1, '5': 11, '6': '.viam.app.v1.ViamServerVersion', '9': 2, '10': 'viamServerVersion', '17': true},
    {'1': 'viam_agent_version', '3': 5, '4': 1, '5': 11, '6': '.viam.app.v1.ViamAgentVersion', '9': 3, '10': 'viamAgentVersion', '17': true},
    {'1': 'os', '3': 6, '4': 1, '5': 9, '9': 4, '10': 'os', '17': true},
    {'1': 'platform', '3': 7, '4': 1, '5': 9, '9': 5, '10': 'platform', '17': true},
    {'1': 'public_ip_address', '3': 8, '4': 1, '5': 9, '9': 6, '10': 'publicIpAddress', '17': true},
    {'1': 'dns_name', '3': 10, '4': 1, '5': 9, '9': 7, '10': 'dnsName', '17': true},
...
final $typed_data.Uint8List partSummaryDescriptor = $convert.base64Decode(
    ...
    'gJUghwYXJ0TmFtZRIgCgxpc19tYWluX3BhcnQYCyABKAhSCmlzTWFpblBhcnQSOwoMb25saW5l'
    'X3N0YXRlGAwgASgOMhgudmlhbS5hcHAudjEuT25saW5lU3RhdGVSC29ubGluZVN0YXRlEjAKFH'
    'NlY29uZHNfc2luY2Vfb25saW5lGA0gASgDUhJzZWNvbmRzU2luY2VPbmxpbmUSQAoLbGFzdF9h'
    'Y2Nlc3MYDiABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wSABSCmxhc3RBY2Nlc3OIAQ'
    'ESQAoLbGFzdF9vbmxpbmUYAyABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wSAFSCmxh'
    'c3RPbmxpbmWIAQESUwoTdmlhbV9zZXJ2ZXJfdmVyc2lvbhgEIAEoCzIeLnZpYW0uYXBwLnYxLl'
    'ZpYW1TZXJ2ZXJWZXJzaW9uSAJSEXZpYW1TZXJ2ZXJWZXJzaW9uiAEBElAKEnZpYW1fYWdlbnRf'
    'dmVyc2lvbhgFIAEoCzIdLnZpYW0uYXBwLnYxLlZpYW1BZ2VudFZlcnNpb25IA1IQdmlhbUFnZW'
    '50VmVyc2lvbogBARITCgJvcxgGIAEoCUgEUgJvc4gBARIfCghwbGF0Zm9ybRgHIAEoCUgFUghw'
    'bGF0Zm9ybYgBARIvChFwdWJsaWNfaXBfYWRkcmVzcxgIIAEoCUgGUg9wdWJsaWNJcEFkZHJlc3'
    'OIAQESHgoIZG5zX25hbWUYCiABKAlIB1IHZG5zTmFtZYgBARI6CglmcmFnbWVudHMYCSADKAsy'
    'HC52aWFtLmFwcC52MS5GcmFnbWVudFN1bW1hcnlSCWZyYWdtZW50c0IOCgxfbGFzdF9hY2Nlc3'
    'NCDgoMX2xhc3Rfb25saW5lQhYKFF92aWFtX3NlcnZlcl92ZXJzaW9uQhUKE192aWFtX2FnZW50'
    'X3ZlcnNpb25CBQoDX29zQgsKCV9wbGF0Zm9ybUIUChJfcHVibGljX2lwX2FkZHJlc3NCCwoJX2'
    'Ruc19uYW1l');
...
final $typed_data.Uint8List getRobotMetadataResponseDescriptor = $convert.base64Decode(
    'ChhHZXRSb2JvdE1ldGFkYXRhUmVzcG9uc2USKwoEZGF0YRgBIAEoCzIXLmdvb2dsZS5wcm90b2'
...
final $typed_data.Uint8List updateRobotMetadataRequestDescriptor = $convert.base64Decode(
    'ChpVcGRhdGVSb2JvdE1ldGFkYXRhUmVxdWVzdBIOCgJpZBgBIAEoCVICaWQSKwoEZGF0YRgCIA'
...
const ModuleVersion$json = {
  ...
  '2': [
    ...
    {'1': 'min_viam_server_version', '3': 9, '4': 1, '5': 9, '9': 3, '10': 'minViamServerVersion', '17': true},
  ],
  '8': [
    {'1': '_first_run'},
    {'1': '_markdown_description'},
    {'1': '_deprecated_status'},
    {'1': '_min_viam_server_version'},
  ],
};
...
final $typed_data.Uint8List moduleVersionDescriptor = $convert.base64Decode(
    ...
    'cHJlY2F0ZWRTdGF0dXNIAlIQZGVwcmVjYXRlZFN0YXR1c4gBARI6ChdtaW5fdmlhbV9zZXJ2ZX'
    'JfdmVyc2lvbhgJIAEoCUgDUhRtaW5WaWFtU2VydmVyVmVyc2lvbogBAUIMCgpfZmlyc3RfcnVu'
    'QhcKFV9tYXJrZG93bl9kZXNjcmlwdGlvbkIUChJfZGVwcmVjYXRlZF9zdGF0dXNCGgoYX21pbl'
    '92aWFtX3NlcnZlcl92ZXJzaW9u');
...
const ModuleMetadata$json = {
  ...
  '2': [
    ...
    {'1': 'min_viam_server_version', '3': 9, '4': 1, '5': 9, '9': 4, '10': 'minViamServerVersion', '17': true},
  ],
  '8': [
    {'1': '_first_run'},
    {'1': '_markdown_description'},
...
final $typed_data.Uint8List moduleMetadataDescriptor = $convert.base64Decode(
    ...
    'VhZ2VIA1IIbGFuZ3VhZ2WIAQESOgoXbWluX3ZpYW1fc2VydmVyX3ZlcnNpb24YCSABKAlIBFIU'
    'bWluVmlhbVNlcnZlclZlcnNpb26IAQFCDAoKX2ZpcnN0X3J1bkIXChVfbWFya2Rvd25fZGVzY3'
    'JpcHRpb25CDgoMX3NvdXJjZV90eXBlQgsKCV9sYW5ndWFnZUIaChhfbWluX3ZpYW1fc2VydmVy'
    'X3ZlcnNpb24=');
...
const UpdateModuleMetadata$json = {
  ...
  '2': [
    ...
    {'1': 'min_viam_server_version', '3': 6, '4': 1, '5': 9, '9': 2, '10': 'minViamServerVersion', '17': true},
  ],
  '8': [
    {'1': '_source_type'},
    {'1': '_language'},
...
final $typed_data.Uint8List updateModuleMetadataDescriptor = $convert.base64Decode(
    ...
    'DjIbLnZpYW0uYXBwLnYxLk1vZHVsZUxhbmd1YWdlSAFSCGxhbmd1YWdliAEBEjoKF21pbl92aW'
    'FtX3NlcnZlcl92ZXJzaW9uGAYgASgJSAJSFG1pblZpYW1TZXJ2ZXJWZXJzaW9uiAEBQg4KDF9z'
    'b3VyY2VfdHlwZUILCglfbGFuZ3VhZ2VCGgoYX21pbl92aWFtX3NlcnZlcl92ZXJzaW9u');

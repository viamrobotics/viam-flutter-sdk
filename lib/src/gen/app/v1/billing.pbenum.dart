...
class PaymentMethodType extends $pb.ProtobufEnum {
  static const PaymentMethodType PAYMENT_METHOD_TYPE_UNSPECIFIED = PaymentMethodType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYMENT_METHOD_TYPE_UNSPECIFIED');
  static const PaymentMethodType PAYMENT_METHOD_TYPE_CARD = PaymentMethodType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYMENT_METHOD_TYPE_CARD');

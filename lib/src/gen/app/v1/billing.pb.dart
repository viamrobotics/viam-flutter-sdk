...
class InvoiceSummary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InvoiceSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$6.Timestamp>(2, _omitFieldNames ? '' : 'invoiceDate', subBuilder: $6.Timestamp.create)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'invoiceAmount', $pb.PbFieldType.OD)
    ..aOS(4, _omitFieldNames ? '' : 'status')
    ..aOM<$6.Timestamp>(5, _omitFieldNames ? '' : 'dueDate', subBuilder: $6.Timestamp.create)
    ..aOM<$6.Timestamp>(6, _omitFieldNames ? '' : 'paidDate', subBuilder: $6.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $6.Timestamp get invoiceDate => $_getN(1);
  @$pb.TagNumber(2)
  set invoiceDate($6.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasInvoiceDate() => $_has(1);
  @$pb.TagNumber(2)
  void clearInvoiceDate() => clearField(2);
  @$pb.TagNumber(2)
  $6.Timestamp ensureInvoiceDate() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $6.Timestamp get dueDate => $_getN(4);
  @$pb.TagNumber(5)
  set dueDate($6.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDueDate() => $_has(4);
  @$pb.TagNumber(5)
  void clearDueDate() => clearField(5);
  @$pb.TagNumber(5)
  $6.Timestamp ensureDueDate() => $_ensure(4);

  @$pb.TagNumber(6)
  $6.Timestamp get paidDate => $_getN(5);
  @$pb.TagNumber(6)
  set paidDate($6.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPaidDate() => $_has(5);
  @$pb.TagNumber(6)
  void clearPaidDate() => clearField(6);
  @$pb.TagNumber(6)
  $6.Timestamp ensurePaidDate() => $_ensure(5);
}
...
class BillableResourceEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BillableResourceEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$6.Timestamp>(6, _omitFieldNames ? '' : 'occurredAt', subBuilder: $6.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $6.Timestamp get occurredAt => $_getN(5);
  @$pb.TagNumber(6)
  set occurredAt($6.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasOccurredAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearOccurredAt() => clearField(6);
  @$pb.TagNumber(6)
  $6.Timestamp ensureOccurredAt() => $_ensure(5);
...
class GetCurrentMonthUsageResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetCurrentMonthUsageResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ..aOM<$6.Timestamp>(1, _omitFieldNames ? '' : 'startDate', subBuilder: $6.Timestamp.create)
    ..aOM<$6.Timestamp>(2, _omitFieldNames ? '' : 'endDate', subBuilder: $6.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $6.Timestamp get startDate => $_getN(0);
  @$pb.TagNumber(1)
  set startDate($6.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStartDate() => $_has(0);
  @$pb.TagNumber(1)
  void clearStartDate() => clearField(1);
  @$pb.TagNumber(1)
  $6.Timestamp ensureStartDate() => $_ensure(0);

  @$pb.TagNumber(2)
  $6.Timestamp get endDate => $_getN(1);
  @$pb.TagNumber(2)
  set endDate($6.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEndDate() => $_has(1);
  @$pb.TagNumber(2)
  void clearEndDate() => clearField(2);
  @$pb.TagNumber(2)
  $6.Timestamp ensureEndDate() => $_ensure(1);

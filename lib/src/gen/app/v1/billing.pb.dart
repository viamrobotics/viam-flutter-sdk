...
class InvoiceSummary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InvoiceSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ...
    ..aOM<$50.Timestamp>(2, _omitFieldNames ? '' : 'invoiceDate', subBuilder: $50.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $50.Timestamp get invoiceDate => $_getN(1);
  @$pb.TagNumber(2)
  set invoiceDate($50.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasInvoiceDate() => $_has(1);
  @$pb.TagNumber(2)
  void clearInvoiceDate() => clearField(2);
  @$pb.TagNumber(2)
  $50.Timestamp ensureInvoiceDate() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $50.Timestamp get dueDate => $_getN(4);
  @$pb.TagNumber(5)
  set dueDate($50.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDueDate() => $_has(4);
  @$pb.TagNumber(5)
  void clearDueDate() => clearField(5);
  @$pb.TagNumber(5)
  $50.Timestamp ensureDueDate() => $_ensure(4);

  @$pb.TagNumber(6)
  $50.Timestamp get paidDate => $_getN(5);
  @$pb.TagNumber(6)
  set paidDate($50.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class GetCurrentMonthUsageResponse extends $pb.GeneratedMessage {
  factory GetCurrentMonthUsageResponse({
    $50.Timestamp? startDate,
    $50.Timestamp? endDate,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetCurrentMonthUsageResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.v1'), createEmptyInstance: create)
    ..aOM<$50.Timestamp>(1, _omitFieldNames ? '' : 'startDate', subBuilder: $50.Timestamp.create)
    ..aOM<$50.Timestamp>(2, _omitFieldNames ? '' : 'endDate', subBuilder: $50.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $50.Timestamp get startDate => $_getN(0);
  @$pb.TagNumber(1)
  set startDate($50.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStartDate() => $_has(0);
  @$pb.TagNumber(1)
  void clearStartDate() => clearField(1);
  @$pb.TagNumber(1)
  $50.Timestamp ensureStartDate() => $_ensure(0);

  @$pb.TagNumber(2)
  $50.Timestamp get endDate => $_getN(1);
  @$pb.TagNumber(2)
  set endDate($50.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEndDate() => $_has(1);
  @$pb.TagNumber(2)
  void clearEndDate() => clearField(2);
  @$pb.TagNumber(2)
  $50.Timestamp ensureEndDate() => $_ensure(1);

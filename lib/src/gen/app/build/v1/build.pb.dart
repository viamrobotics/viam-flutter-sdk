...
class JobInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.app.build.v1'), createEmptyInstance: create)
    ...
    ..aOM<$52.Timestamp>(5, _omitFieldNames ? '' : 'startTime', subBuilder: $52.Timestamp.create)
    ..aOM<$52.Timestamp>(6, _omitFieldNames ? '' : 'endTime', subBuilder: $52.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $52.Timestamp get startTime => $_getN(4);
  @$pb.TagNumber(5)
  set startTime($52.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasStartTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearStartTime() => clearField(5);
  @$pb.TagNumber(5)
  $52.Timestamp ensureStartTime() => $_ensure(4);

  @$pb.TagNumber(6)
  $52.Timestamp get endTime => $_getN(5);
  @$pb.TagNumber(6)
  set endTime($52.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasEndTime() => $_has(5);
  @$pb.TagNumber(6)
  void clearEndTime() => clearField(6);
  @$pb.TagNumber(6)
  $52.Timestamp ensureEndTime() => $_ensure(5);

  @$pb.TagNumber(7)
  $core.String get buildStep => $_getSZ(6);
  @$pb.TagNumber(7)
  set buildStep($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasBuildStep() => $_has(6);
  @$pb.TagNumber(7)
  void clearBuildStep() => clearField(7);
}

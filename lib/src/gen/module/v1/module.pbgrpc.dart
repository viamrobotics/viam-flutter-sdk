...
class ModuleServiceClient extends $grpc.Client {
  static final _$addResource =
      $grpc.ClientMethod<$3.AddResourceRequest, $3.AddResourceResponse>(
          '/viam.module.v1.ModuleService/AddResource',
          ($3.AddResourceRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $3.AddResourceResponse.fromBuffer(value));
  static final _$reconfigureResource = $grpc.ClientMethod<
          $3.ReconfigureResourceRequest, $3.ReconfigureResourceResponse>(
      '/viam.module.v1.ModuleService/ReconfigureResource',
      ($3.ReconfigureResourceRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $3.ReconfigureResourceResponse.fromBuffer(value));
  static final _$removeResource =
      $grpc.ClientMethod<$3.RemoveResourceRequest, $3.RemoveResourceResponse>(
          '/viam.module.v1.ModuleService/RemoveResource',
          ($3.RemoveResourceRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $3.RemoveResourceResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$3.AddResourceResponse> addResource(
      $3.AddResourceRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addResource, request, options: options);
  }

  $grpc.ResponseFuture<$3.ReconfigureResourceResponse> reconfigureResource(
      $3.ReconfigureResourceRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$reconfigureResource, request, options: options);
  }

  $grpc.ResponseFuture<$3.RemoveResourceResponse> removeResource(
      $3.RemoveResourceRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ModuleServiceBase extends $grpc.Service {
  ...
  ModuleServiceBase() {
    $addMethod(
        $grpc.ServiceMethod<$3.AddResourceRequest, $3.AddResourceResponse>(
            'AddResource',
            addResource_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $3.AddResourceRequest.fromBuffer(value),
            ($3.AddResourceResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.ReconfigureResourceRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $3.ReconfigureResourceRequest.fromBuffer(value),
        ($3.ReconfigureResourceResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.RemoveResourceRequest,
            $3.RemoveResourceResponse>(
        'RemoveResource',
        removeResource_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $3.RemoveResourceRequest.fromBuffer(value),
  ...
  $async.Future<$3.AddResourceResponse> addResource_Pre($grpc.ServiceCall call,
      $async.Future<$3.AddResourceRequest> request) async {
    return addResource(call, await request);
  }

  $async.Future<$3.ReconfigureResourceResponse> reconfigureResource_Pre(
      $grpc.ServiceCall call,
      $async.Future<$3.ReconfigureResourceRequest> request) async {
    return reconfigureResource(call, await request);
  }

  $async.Future<$3.RemoveResourceResponse> removeResource_Pre(
      $grpc.ServiceCall call,
      $async.Future<$3.RemoveResourceRequest> request) async {
    return removeResource(call, await request);
  }

  $async.Future<$3.ReadyResponse> ready_Pre(
      $grpc.ServiceCall call, $async.Future<$3.ReadyRequest> request) async {
  ...
  $async.Future<$3.ReconfigureResourceResponse> reconfigureResource(
      $grpc.ServiceCall call, $3.ReconfigureResourceRequest request);
  $async.Future<$3.RemoveResourceResponse> removeResource(

...
import '../../app/v1/robot.pb.dart' as $12;
import '../../robot/v1/robot.pb.dart' as $30;

class AddResourceRequest extends $pb.GeneratedMessage {
  factory AddResourceRequest({
    $12.ComponentConfig? config,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddResourceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.module.v1'), createEmptyInstance: create)
    ..aOM<$12.ComponentConfig>(1, _omitFieldNames ? '' : 'config', subBuilder: $12.ComponentConfig.create)
  ...
  @$pb.TagNumber(1)
  $12.ComponentConfig get config => $_getN(0);
  @$pb.TagNumber(1)
  set config($12.ComponentConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearConfig() => clearField(1);
  @$pb.TagNumber(1)
  $12.ComponentConfig ensureConfig() => $_ensure(0);
...
class HandlerDefinition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HandlerDefinition', package: const $pb.PackageName(_omitMessageNames ? '' : 'viam.module.v1'), createEmptyInstance: create)
    ..aOM<$30.ResourceRPCSubtype>(1, _omitFieldNames ? '' : 'subtype', subBuilder: $30.ResourceRPCSubtype.create)
  ...
  @$pb.TagNumber(1)
  $30.ResourceRPCSubtype get subtype => $_getN(0);
  @$pb.TagNumber(1)
  set subtype($30.ResourceRPCSubtype v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSubtype() => $_has(0);
  @$pb.TagNumber(1)
  void clearSubtype() => clearField(1);
  @$pb.TagNumber(1)
  $30.ResourceRPCSubtype ensureSubtype() => $_ensure(0);

...
class SignalingServiceClient extends $grpc.Client {
  ...
  static final _$callUpdate =
      $grpc.ClientMethod<$0.CallUpdateRequest, $0.CallUpdateResponse>(
          '/proto.rpc.webrtc.v1.SignalingService/CallUpdate',
          ($0.CallUpdateRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.CallUpdateResponse.fromBuffer(value));
  static final _$answer =
      $grpc.ClientMethod<$0.AnswerResponse, $0.AnswerRequest>(
  ...
  static final _$optionalWebRTCConfig = $grpc.ClientMethod<
          $0.OptionalWebRTCConfigRequest, $0.OptionalWebRTCConfigResponse>(
      '/proto.rpc.webrtc.v1.SignalingService/OptionalWebRTCConfig',
      ($0.OptionalWebRTCConfigRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.OptionalWebRTCConfigResponse.fromBuffer(value));
  ...
  $grpc.ResponseStream<$0.CallResponse> call($0.CallRequest request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$call, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseFuture<$0.CallUpdateResponse> callUpdate(
      $0.CallUpdateRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$callUpdate, request, options: options);
  }

  $grpc.ResponseStream<$0.AnswerRequest> answer(
      $async.Stream<$0.AnswerResponse> request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$answer, request, options: options);
  }

  $grpc.ResponseFuture<$0.OptionalWebRTCConfigResponse> optionalWebRTCConfig(
      $0.OptionalWebRTCConfigRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class SignalingServiceBase extends $grpc.Service {
  ...
  SignalingServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.OptionalWebRTCConfigRequest,
            $0.OptionalWebRTCConfigResponse>(
        'OptionalWebRTCConfig',
        optionalWebRTCConfig_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.OptionalWebRTCConfigRequest.fromBuffer(value),
  ...
  $async.Future<$0.CallUpdateResponse> callUpdate_Pre($grpc.ServiceCall call,
      $async.Future<$0.CallUpdateRequest> request) async {
    return callUpdate(call, await request);
  }

  $async.Future<$0.OptionalWebRTCConfigResponse> optionalWebRTCConfig_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.OptionalWebRTCConfigRequest> request) async {
    return optionalWebRTCConfig(call, await request);
  }

  $async.Stream<$0.CallResponse> call(
      $grpc.ServiceCall call, $0.CallRequest request);
  $async.Future<$0.CallUpdateResponse> callUpdate(
      $grpc.ServiceCall call, $0.CallUpdateRequest request);
  $async.Stream<$0.AnswerRequest> answer(
      $grpc.ServiceCall call, $async.Stream<$0.AnswerResponse> request);
  $async.Future<$0.OptionalWebRTCConfigResponse> optionalWebRTCConfig(
      $grpc.ServiceCall call, $0.OptionalWebRTCConfigRequest request);
}

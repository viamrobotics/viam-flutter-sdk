...
class StreamServiceClient extends $grpc.Client {
  static final _$listStreams =
      $grpc.ClientMethod<$0.ListStreamsRequest, $0.ListStreamsResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListStreamsResponse.fromBuffer(value));
  static final _$addStream =
      $grpc.ClientMethod<$0.AddStreamRequest, $0.AddStreamResponse>(
          '/proto.stream.v1.StreamService/AddStream',
          ($0.AddStreamRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.AddStreamResponse.fromBuffer(value));
  static final _$removeStream =
      $grpc.ClientMethod<$0.RemoveStreamRequest, $0.RemoveStreamResponse>(
          '/proto.stream.v1.StreamService/RemoveStream',
          ($0.RemoveStreamRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.RemoveStreamResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.AddStreamResponse> addStream(
      $0.AddStreamRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addStream, request, options: options);
  }

  $grpc.ResponseFuture<$0.RemoveStreamResponse> removeStream(
      $0.RemoveStreamRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class StreamServiceBase extends $grpc.Service {
  ...
  StreamServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.RemoveStreamRequest, $0.RemoveStreamResponse>(
            'RemoveStream',
            removeStream_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.RemoveStreamRequest.fromBuffer(value),
  ...
  $async.Future<$0.AddStreamResponse> addStream_Pre($grpc.ServiceCall call,
      $async.Future<$0.AddStreamRequest> request) async {
    return addStream(call, await request);
  }

  $async.Future<$0.RemoveStreamResponse> removeStream_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.RemoveStreamRequest> request) async {
  ...
  $async.Future<$0.AddStreamResponse> addStream(
      $grpc.ServiceCall call, $0.AddStreamRequest request);
  $async.Future<$0.RemoveStreamResponse> removeStream(
      $grpc.ServiceCall call, $0.RemoveStreamRequest request);
}

...
class ExprValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExprValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$16.Value>(1, _omitFieldNames ? '' : 'value', subBuilder: $16.Value.create)
  ...
  /// A concrete value.
  @$pb.TagNumber(1)
  $16.Value get value => $_getN(0);
  @$pb.TagNumber(1)
  set value($16.Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasValue() => $_has(0);
  @$pb.TagNumber(1)
  void clearValue() => clearField(1);
  @$pb.TagNumber(1)
  $16.Value ensureValue() => $_ensure(0);
...
class ErrorSet extends $pb.GeneratedMessage {
  factory ErrorSet({
    $core.Iterable<$13.Status>? errors,
  }) {
    final $result = create();
    if (errors != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ErrorSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1beta1'), createEmptyInstance: create)
    ..pc<$13.Status>(1, _omitFieldNames ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: $13.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$13.Status> get errors => $_getList(0);
}

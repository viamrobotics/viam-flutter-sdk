...
const EvalState$json = {
  '1': 'EvalState',
  '2': [
    {'1': 'values', '3': 1, '4': 3, '5': 11, '6': '.google.api.expr.v1alpha1.ExprValue', '10': 'values'},
    {'1': 'results', '3': 3, '4': 3, '5': 11, '6': '.google.api.expr.v1alpha1.EvalState.Result', '10': 'results'},
  ],
...
const ExprValue$json = {
  '1': 'ExprValue',
  '2': [
    {'1': 'value', '3': 1, '4': 1, '5': 11, '6': '.google.api.expr.v1alpha1.Value', '9': 0, '10': 'value'},
    {'1': 'error', '3': 2, '4': 1, '5': 11, '6': '.google.api.expr.v1alpha1.ErrorSet', '9': 0, '10': 'error'},
    {'1': 'unknown', '3': 3, '4': 1, '5': 11, '6': '.google.api.expr.v1alpha1.UnknownSet', '9': 0, '10': 'unknown'},
  ],
  '8': [
    {'1': 'kind'},
  ],
...
final $typed_data.Uint8List unknownSetDescriptor = $convert.base64Decode(
    'CgpVbmtub3duU2V0EhQKBWV4cHJzGAEgAygDUgVleHBycw==');

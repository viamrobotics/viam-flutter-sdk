...
class CheckedExpr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckedExpr', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$10.Expr>(4, _omitFieldNames ? '' : 'expr', subBuilder: $10.Expr.create)
    ..aOM<$10.SourceInfo>(5, _omitFieldNames ? '' : 'sourceInfo', subBuilder: $10.SourceInfo.create)
  ...
  @$pb.TagNumber(4)
  $10.Expr get expr => $_getN(2);
  @$pb.TagNumber(4)
  set expr($10.Expr v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasExpr() => $_has(2);
  @$pb.TagNumber(4)
  void clearExpr() => clearField(4);
  @$pb.TagNumber(4)
  $10.Expr ensureExpr() => $_ensure(2);

  /// The source info derived from input that generated the parsed `expr` and
  /// any optimizations made during the type-checking pass.
  @$pb.TagNumber(5)
  $10.SourceInfo get sourceInfo => $_getN(3);
  @$pb.TagNumber(5)
  set sourceInfo($10.SourceInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSourceInfo() => $_has(3);
  @$pb.TagNumber(5)
  void clearSourceInfo() => clearField(5);
  @$pb.TagNumber(5)
  $10.SourceInfo ensureSourceInfo() => $_ensure(3);
...
class Type extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Type', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..e<$9.NullValue>(2, _omitFieldNames ? '' : 'null', $pb.PbFieldType.OE, defaultOrMaker: $9.NullValue.NULL_VALUE, valueOf: $9.NullValue.valueOf, enumValues: $9.NullValue.values)
  ...
  /// Null value.
  @$pb.TagNumber(2)
  $9.NullValue get null_2 => $_getN(1);
  @$pb.TagNumber(2)
  set null_2($9.NullValue v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Decl_IdentDecl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Decl.IdentDecl', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$10.Constant>(2, _omitFieldNames ? '' : 'value', subBuilder: $10.Constant.create)
  ...
  @$pb.TagNumber(2)
  $10.Constant get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($10.Constant v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $10.Constant ensureValue() => $_ensure(1);
...
class Reference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$10.Constant>(4, _omitFieldNames ? '' : 'value', subBuilder: $10.Constant.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $10.Constant get value => $_getN(2);
  @$pb.TagNumber(4)
  set value($10.Constant v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValue() => $_has(2);
  @$pb.TagNumber(4)
  void clearValue() => clearField(4);
  @$pb.TagNumber(4)
  $10.Constant ensureValue() => $_ensure(2);
}

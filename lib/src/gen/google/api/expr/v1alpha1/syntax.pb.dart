...
class ParsedExpr extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set sourceInfo(SourceInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Expr_CreateStruct_Entry extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set optionalEntry($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
...
class Expr extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set constExpr(Constant v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Constant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Constant', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$6.Duration>(8, _omitFieldNames ? '' : 'durationValue', subBuilder: $6.Duration.create)
    ..aOM<$8.Timestamp>(9, _omitFieldNames ? '' : 'timestampValue', subBuilder: $8.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.pragma('dart2js:noInline')
  static Constant getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Constant>(create);
  static Constant? _defaultInstance;

  Constant_ConstantKind whichConstantKind() => _Constant_ConstantKindByTag[$_whichOneof(0)]!;
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  set durationValue($6.Duration v) { setField(8, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  $6.Duration ensureDurationValue() => $_ensure(7);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  set timestampValue($8.Timestamp v) { setField(9, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  $8.Timestamp ensureTimestampValue() => $_ensure(8);
}
...
class SourceInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set syntaxVersion($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)

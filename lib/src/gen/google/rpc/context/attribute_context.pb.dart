...
class AttributeContext_Auth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Auth', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$9.Struct>(4, _omitFieldNames ? '' : 'claims', subBuilder: $9.Struct.create)
  ...
  ///  dependent structure.
  @$pb.TagNumber(4)
  $9.Struct get claims => $_getN(3);
  @$pb.TagNumber(4)
  set claims($9.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasClaims() => $_has(3);
  @$pb.TagNumber(4)
  void clearClaims() => clearField(4);
  @$pb.TagNumber(4)
  $9.Struct ensureClaims() => $_ensure(3);
...
class AttributeContext_Request extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Request', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$8.Timestamp>(9, _omitFieldNames ? '' : 'time', subBuilder: $8.Timestamp.create)
  ...
  /// the request.
  @$pb.TagNumber(9)
  $8.Timestamp get time => $_getN(7);
  @$pb.TagNumber(9)
  set time($8.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTime() => $_has(7);
  @$pb.TagNumber(9)
  void clearTime() => clearField(9);
  @$pb.TagNumber(9)
  $8.Timestamp ensureTime() => $_ensure(7);
...
class AttributeContext_Response extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Response', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$8.Timestamp>(4, _omitFieldNames ? '' : 'time', subBuilder: $8.Timestamp.create)
    ..aOM<$6.Duration>(5, _omitFieldNames ? '' : 'backendLatency', subBuilder: $6.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  /// the response.
  @$pb.TagNumber(4)
  $8.Timestamp get time => $_getN(3);
  @$pb.TagNumber(4)
  set time($8.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearTime() => clearField(4);
  @$pb.TagNumber(4)
  $8.Timestamp ensureTime() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $6.Duration get backendLatency => $_getN(4);
  @$pb.TagNumber(5)
  set backendLatency($6.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBackendLatency() => $_has(4);
  @$pb.TagNumber(5)
  void clearBackendLatency() => clearField(5);
  @$pb.TagNumber(5)
  $6.Duration ensureBackendLatency() => $_ensure(4);
}
...
class AttributeContext_Resource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Resource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$8.Timestamp>(8, _omitFieldNames ? '' : 'createTime', subBuilder: $8.Timestamp.create)
    ..aOM<$8.Timestamp>(9, _omitFieldNames ? '' : 'updateTime', subBuilder: $8.Timestamp.create)
    ..aOM<$8.Timestamp>(10, _omitFieldNames ? '' : 'deleteTime', subBuilder: $8.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $8.Timestamp get createTime => $_getN(7);
  @$pb.TagNumber(8)
  set createTime($8.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCreateTime() => $_has(7);
  @$pb.TagNumber(8)
  void clearCreateTime() => clearField(8);
  @$pb.TagNumber(8)
  $8.Timestamp ensureCreateTime() => $_ensure(7);

  /// Output only. The timestamp when the resource was last updated. Any
  /// change to the resource made by users must refresh this value.
  /// Changes to a resource made by the service should refresh this value.
  @$pb.TagNumber(9)
  $8.Timestamp get updateTime => $_getN(8);
  @$pb.TagNumber(9)
  set updateTime($8.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUpdateTime() => $_has(8);
  @$pb.TagNumber(9)
  void clearUpdateTime() => clearField(9);
  @$pb.TagNumber(9)
  $8.Timestamp ensureUpdateTime() => $_ensure(8);

  /// Output only. The timestamp when the resource was deleted.
  /// If the resource is not deleted, this must be empty.
  @$pb.TagNumber(10)
  $8.Timestamp get deleteTime => $_getN(9);
  @$pb.TagNumber(10)
  set deleteTime($8.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDeleteTime() => $_has(9);
  @$pb.TagNumber(10)
  void clearDeleteTime() => clearField(10);
  @$pb.TagNumber(10)
  $8.Timestamp ensureDeleteTime() => $_ensure(9);
...
class AttributeContext extends $pb.GeneratedMessage {
  factory AttributeContext({
    ...
    $core.Iterable<$11.Any>? extensions,
  }) {
    final $result = create();
    if (source != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..pc<$11.Any>(8, _omitFieldNames ? '' : 'extensions', $pb.PbFieldType.PM, subBuilder: $11.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.List<$11.Any> get extensions => $_getList(7);
}

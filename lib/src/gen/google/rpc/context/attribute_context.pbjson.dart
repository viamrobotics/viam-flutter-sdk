...
const AttributeContext$json = {
  ...
  '2': [
    ...
    {'1': 'extensions', '3': 8, '4': 3, '5': 11, '6': '.google.protobuf.Any', '10': 'extensions'},
  ],
...
const AttributeContext_Request$json = {
  ...
  '2': [
    ...
    {'1': 'origin', '3': 14, '4': 1, '5': 9, '10': 'origin'},
  ],
...
const AttributeContext_Response$json = {
  ...
  '2': [
    ...
    {'1': 'backend_latency', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'backendLatency'},
  ],
...
const AttributeContext_Resource$json = {
  ...
  '2': [
    ...
    {'1': 'annotations', '3': 6, '4': 3, '5': 11, '6': '.google.rpc.context.AttributeContext.Resource.AnnotationsEntry', '10': 'annotations'},
  ...
  '3': [AttributeContext_Resource_LabelsEntry$json, AttributeContext_Resource_AnnotationsEntry$json],
};
...
final $typed_data.Uint8List attributeContextDescriptor = $convert.base64Decode(
    ...
    'ZWxzGucDCgdSZXF1ZXN0Eg4KAmlkGAEgASgJUgJpZBIWCgZtZXRob2QYAiABKAlSBm1ldGhvZB'
    ...
    'V0ZUNvbnRleHQuQXV0aFIEYXV0aBIWCgZvcmlnaW4YDiABKAlSBm9yaWdpbho6CgxIZWFkZXJz'
    'RW50cnkSEAoDa2V5GAEgASgJUgNrZXkSFAoFdmFsdWUYAiABKAlSBXZhbHVlOgI4ARq4AgoIUm'
    'VzcG9uc2USEgoEY29kZRgBIAEoA1IEY29kZRISCgRzaXplGAIgASgDUgRzaXplElQKB2hlYWRl'
    'cnMYAyADKAsyOi5nb29nbGUucnBjLmNvbnRleHQuQXR0cmlidXRlQ29udGV4dC5SZXNwb25zZS'
    '5IZWFkZXJzRW50cnlSB2hlYWRlcnMSLgoEdGltZRgEIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5U'
    'aW1lc3RhbXBSBHRpbWUSQgoPYmFja2VuZF9sYXRlbmN5GAUgASgLMhkuZ29vZ2xlLnByb3RvYn'
    'VmLkR1cmF0aW9uUg5iYWNrZW5kTGF0ZW5jeRo6CgxIZWFkZXJzRW50cnkSEAoDa2V5GAEgASgJ'
    'UgNrZXkSFAoFdmFsdWUYAiABKAlSBXZhbHVlOgI4ARqYBQoIUmVzb3VyY2USGAoHc2VydmljZR'
    'gBIAEoCVIHc2VydmljZRISCgRuYW1lGAIgASgJUgRuYW1lEhIKBHR5cGUYAyABKAlSBHR5cGUS'
    'UQoGbGFiZWxzGAQgAygLMjkuZ29vZ2xlLnJwYy5jb250ZXh0LkF0dHJpYnV0ZUNvbnRleHQuUm'
    'Vzb3VyY2UuTGFiZWxzRW50cnlSBmxhYmVscxIQCgN1aWQYBSABKAlSA3VpZBJgCgthbm5vdGF0'
    'aW9ucxgGIAMoCzI+Lmdvb2dsZS5ycGMuY29udGV4dC5BdHRyaWJ1dGVDb250ZXh0LlJlc291cm'
    'NlLkFubm90YXRpb25zRW50cnlSC2Fubm90YXRpb25zEiEKDGRpc3BsYXlfbmFtZRgHIAEoCVIL'
    'ZGlzcGxheU5hbWUSOwoLY3JlYXRlX3RpbWUYCCABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZX'
    'N0YW1wUgpjcmVhdGVUaW1lEjsKC3VwZGF0ZV90aW1lGAkgASgLMhouZ29vZ2xlLnByb3RvYnVm'
    'LlRpbWVzdGFtcFIKdXBkYXRlVGltZRI7CgtkZWxldGVfdGltZRgKIAEoCzIaLmdvb2dsZS5wcm'
    '90b2J1Zi5UaW1lc3RhbXBSCmRlbGV0ZVRpbWUSEgoEZXRhZxgLIAEoCVIEZXRhZxIaCghsb2Nh'
    'dGlvbhgMIAEoCVIIbG9jYXRpb24aOQoLTGFiZWxzRW50cnkSEAoDa2V5GAEgASgJUgNrZXkSFA'
    'oFdmFsdWUYAiABKAlSBXZhbHVlOgI4ARo+ChBBbm5vdGF0aW9uc0VudHJ5EhAKA2tleRgBIAEo'
